...
*Beklenen süre aralık boyutuna göre büyük ölçüde değişir. Aşağıdaki tablo Puzzle #66 (2^66 aralık) içindir. Daha yüksek puzzle'lar üstel olarak zorlaşır — Puzzle #135 (2^135 aralık) 2^69× daha zordur.*
...
- **Yerleşik puzzle tablosu** — #66-#74, #135, #140, #145, #150, #155, #160 puzzle'ları, bilinen aralıklar, adresler ve gömülü pubkey'ler
...
# Gömülü pubkey'i olmayan puzzle'lar için --pubkey manuel verilir
bitcoin-kangaroo-solver --puzzle 66 --pubkey 02<64_Hex_Karakter>
```
...
| Bayrak | Açıklama |
|--------|----------|
| `--puzzle <N>` | Yerleşik puzzle 66-74, 135, 140, 145, 150, 155, 160 (aralık + adres + varsa gömülü pubkey belirler) |
...
└── puzzle/mod.rs           # Yerleşik puzzle tablosu (#66-#74, #135-#160 gömülü pubkey'lerle)
kernels/
...
- **Genel anahtar gerektirir** — Kangaroo algoritması yalnızca Bitcoin adresi ile çalışamaz. Çoğu puzzle (#66-#134, #136-#139, #141-#149, #151-#154, #156-#159) yalnızca adres bilgisine sahiptir; sıkıştırılmış genel anahtarı harici kaynaklardan edinmeniz gerekir. Sadece #135, #140, #145, #150, #155, #160 numaralı puzzle'ların genel anahtarı bilinmektedir ve Kangaroo için uygundur.
